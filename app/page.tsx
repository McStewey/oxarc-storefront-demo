...
export default function Home() {
  ...
  return <main>
    ...
    <nav><button>☰ All products</button>{categoryNav.map(x=><a key={x} href="#shop">{x}</a>)}<a href="#about">About OXARC</a><a href="#shop" className="quick">Quick order →</a></nav>
    ...
    <section className="about-oxarc" id="about">
      <div className="about-intro"><span className="kicker">LOCAL EXPERTISE. REGIONAL REACH.</span><h2>About OXARC</h2><p>Since 1968, OXARC has served customers across the Northwestern United States as a single-source supplier for welding equipment, consumables, industrial and specialty gases, and safety supplies.</p><p>Local technical expertise and personalized service are backed by warehouses, distribution centers and OXARC&apos;s own delivery fleet—helping businesses keep critical products moving and operations running efficiently.</p><div className="about-actions"><a className="about-primary" href="#shop">Continue shopping</a><a href="https://meritusgas.com/partners/oxarc/locations/" target="_blank" rel="noreferrer">Find an OXARC location</a></div></div>
      <div className="about-capabilities"><article><b>Welding & industrial supplies</b><p>Welding machines, automation, filler metals, abrasives, hand tools and shop essentials.</p></article><article><b>Safety products & service</b><p>Jobsite PPE, emerging safety technology and practical regulatory-compliance support.</p></article><article><b>Gases & chemicals</b><p>Industrial and specialty gases with high-purity options and efficient regional delivery.</p></article><article><b>CO₂, beverage & dry ice</b><p>Carbon-dioxide and dry-ice solutions for food, beverage and commercial applications.</p></article><div className="about-proof"><strong>Northwest service since 1968</strong><span>Local attention, expert advice and the resources of Meritus Gas Partners.</span></div></div>
    </section>
  </main>;
}
